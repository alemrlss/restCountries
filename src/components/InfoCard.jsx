...
function InfoCard() {
  ...
  <div className="p-10 mb-24">
        <Link
          className="bg-gray-600 hover:bg-gray-900 text-white font-bold py-2 px-4 ml-16 rounded"
          to={"/home"}
        > 
          {" "}
          Back{" "}
 ...
 <div className="text-infoCard flex-1 flex ml-24">
