...
function CardCountry({ data }) {
  ...
  return (
    <section className="card-countries flex flex-col p-0 bg-white rounded-lg m-12 hover:m-10 hover:ease-in-out duration-500 hover:cursor-pointer">
      <img
        src={data.flags.png}
      ...
      <div className="p-3 bg-white rounded-b-lg">
        ...
        <p className="text-s">Population: {data.population}</p>
